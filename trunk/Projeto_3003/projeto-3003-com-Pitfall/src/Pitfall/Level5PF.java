...
public class Level5PF extends Game5 {	
		...
		public Level5PF()
		{
			...
			jacare = new JacarePF("/images/PF_Jacare.png", new Point2D.Double(240, 345), new Point(50, 30), 100 + Game.random.nextInt(200));
			jacare2 = new JacarePF("/images/PF_Jacare.png", new Point2D.Double(370, 345), new Point(50, 30), 100 + Game.random.nextInt(200));
			jacare3 = new JacarePF("/images/PF_Jacare.png", new Point2D.Double(500, 345), new Point(50, 30), 100 + Game.random.nextInt(200));
